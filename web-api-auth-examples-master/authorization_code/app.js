...
app.get('/login', function(req, res) {
  ...
  // your application requests authorization, first call, here we are starting the process
  // to authenticate the user to be able to access data
...
app.get('/error', function(req, res) {
  ...
  res.render('error, something went wrong FIXME', { error: error });
});

// refresh token route, necessary as tokens expire after an hour
